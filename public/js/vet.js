...
function showPosition(position) {
    ...
    let url = `https://cors-anywhere.herokuapp.com/https://atlas.mapmyindia.com/api/places/nearby/json?keywords=pharmacy&page=1&region=IND&refLocation=${coords1}%2C${coords2}`;
    //y.innerHTML = coords2; 
    ...
    async function getapi(url) {
        ...
        const headers = {
            ...
            'Authorization': 'bearer 89c73828-2920-47ca-b947-614edc8665b8'
